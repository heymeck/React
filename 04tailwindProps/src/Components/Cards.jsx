...
function Cards({username,title}) {
    // console.log("properties:", username)
  return (
    <div className="bg-neutral-primary-soft block max-w-sm p-6 border border-default rounded-base shadow-xs mt-10">
    <a href="#">
        <img className="rounded-base rounded-3xl" src="https://images.pexels.com/photos/19703526/pexels-photo-19703526.jpeg" alt="" />
    </a>
    <a href="#">
        <h5 className="mt-6 mb-2 text-2xl font-semibold tracking-tight text-heading">Streamlining your design process today {username}  {title}</h5>
    </a>
